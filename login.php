...
Online Attendence System    </div>
    </div>
  <form method="post" action="login.php">
       <h1>SIGN IN</h1>
  	<?php include('errors.php'); ?>
  	 <input type="text" class="input1" name="StaffName" placeholder="Staff Name*"  required>
 <input type="password" class="input1" name="password" placeholder="Password*" required>
 <input type="number" class="input1" name="Sem" placeholder="Sem*" required>
